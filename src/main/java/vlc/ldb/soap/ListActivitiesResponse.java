 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://soap.ldb.vlc/}activityTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ListActivitiesResponse {
    ...
    protected List<ActivityTO> _return;
     ...
     * 
     */
    public List<ActivityTO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ActivityTO>();
        }
        return this._return;
    }
